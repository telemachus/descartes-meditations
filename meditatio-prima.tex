...
\lemc{vel a sensibus vel per sensus} Descartes probably has in mind an Aristotelian distinction between direct sensory perception (e.g., the redness of an apple) and indirect perception through sensation (e.g., that a friend is approaching). The distinction may help Descartes' argument here insofar as it broadens the scope of sense-based beliefs. 
