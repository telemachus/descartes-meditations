...
\lem{2 Nunquid} = \textit{Numquid}, a word with no one exact translation into English. In classical Latin it introduces questions that (i) involve emotion, (ii) express incredulity, or (iii) are rhetorical. (These categories can overlap.) Usually questions with \textit{numquid} expect a negative answer. In the \textit{Meditations}, however, the inquirer uses \textit{nunquid} in contexts where it is clear she expects an affirmative answer. In this case, she suggestings the existence of god as perhaps something that provides no possibility for doubt.
...
\lemc{1 nunc} the previous paragraph began with \textit{antehac}, and the contrast is important. After reviewing what she used to believe, the inquirer goes on to consider what she should believe now---after her sceptical investigations in the first meditation.
...
\lemc{5-8 Nutriri\dots incedere\dots Sentire\dots Cogitare} The easiest way to take these infinitives is that they function as nominatives in sentences with no verb. (Remember that the gerund does not appear in the nominative, but infinitives often serve as subjects.) As in English, the grammar may seem tricky, but it is perfectly clear what the inquirer means. She asks ``What should I think about the things I used to attribute to my soul?'' and then she fills in what some of these things were: ``Feeding or walking?\dots Perceiving?\dots Thinking?'' She could have used nouns instead of infinitives, and in fact she follows \textit{cogitare} with \textit{cogitatio}.
...
\lemc{12--13 mens\dots ratio} the inquirer offers various synonyms for ``mind'' here. In some contexts, these Latin words can have different connotations, but the inquirer lists them simply to indicate that when she says that she is a \textit{res cogitans}, she intends the meaning shared by all of these words.
...
\lemc{15 remanet cera} adversative asyndeton, the omission of adversative conjunctions. E.g., ``I see it; I do not believe it'' rather than ``I see it, but I do not believe it.''
% -]] This wax
